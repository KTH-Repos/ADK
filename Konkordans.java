...
class Konkordans {
    ...
    // Filer (KTH)
     ...
     private static final File FILE_KORPUS = new File("/var/tmp/III.txt");
     private static final File FILE_A = new File("/var/tmp/AAA.txt");
     private static final File FILE_I = new File("/var/tmp/PPP.txt");
